...
docker build -f="Dcycle-Dockerfile-drupal7site-internal" -t $PROJECTNAME-dcycle-drupal7site-internal .
...
docker run -p $PORT:80 -d $PROJECTNAME-dcycle-drupal7site-internal

echo -e "..."
echo -e "Please run ./dcycle/install.sh $PROJECTNAME-dcycle-drupal7site-internal"
